...
const Achievement = () => {
    ...
    return (
            <div className="max-w-[1400px] h-[500px] bg-blue-100 mx-auto my-auto my-20 pt-16 
        lg:mb-[20%] md:mb-[35%]px-4 grid lg:grid-cols-3 gap-4 m-auto">
                <div className="lg:top-20 relative lg:col-span-1 col-span-2">
                    <h3 className="text-2xl font-bold m-auto">Can Achieve</h3>
                ...
                <div className="grid grid-cols-2 col-span-2 gap-2 m-auto">
